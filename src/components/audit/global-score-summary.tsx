...
export function GlobalScoreSummary({ scores }: Props) {
  ...
  return (
    <GlassCard variant="strong" className="flex flex-col justify-between p-6 sm:p-8">
      <div>
      ...
      <div
        className={`mt-8 flex items-center gap-2 rounded-xl border border-white/5 bg-gradient-to-br ${ring} px-4 py-3 text-xs text-zinc-400`}
      >
